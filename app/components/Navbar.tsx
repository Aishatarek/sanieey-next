    ...
    >
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <ul className="hidden lg:flex space-x-6 text-gray-700 font-medium">
          ...
          <li>
            <Link href="/specialties" className="hover:text-orange-500">
              اكتشف التخصصات
            </Link>
          </li>
          <li>
            <Link href="/industrial-list" className="hover:text-orange-500">
              قائمة الصنايعية
            </Link>
          </li>
          <li>
            <Link href="/recommend" className="hover:text-orange-500">
              رشّح صنايعي
            </Link>
          </li>
          <li>
            <Link href="/contactus" className="hover:text-orange-500">
              تواصل معنا
            </Link>
          </li>
          <li>
        ...
        {isUserLogged ? (
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="relative dropdown-container">
                ...
                <img
                  src={
                    userData?.profileImagePath
                      ? `https://sani3ywebapiv1.runasp.net${userData?.profileImagePath}`
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 drop-down-user">
                  {localStorage.getItem("role") == "User" ? (
                    <>
                      <Link
                        href="/user-dashboard/personal-data"
                        className="btn text-right"
                      >
                        <img src="/images/nav/profile-circle.svg" alt="" />
                      ...
                      <Link
                        ...
                        className="btn text-right"
                      >
                        <img src="/images/nav/calendar-tick.svg" alt="" />
                      ...
                      <Link
                        ...
                        className="btn text-right"
                      >
                        <img src="/images/nav/archive-minus.svg" alt="" />
                        <span>التقــيـيـمات</span>
                      </Link>
                      <Link
                        href="/user-dashboard/recommend"
                        className="btn text-right"
                      >
                        <img src="/images/nav/Work.svg" alt="" />
                        <span>الصنايعية المرشحين</span>
                      </Link>
                      <button onClick={handleLogout} className="btn text-right">
                    ...
                    <>
                    <Link
                      href="/sanieey-dashboard/personal-data"
                      className="btn text-right"
                    >
                      <img src="/images/nav/profile-circle.svg" alt="" />
                      <span>الملف الشخصي</span>
                    ...
                    <Link
                      href="/sanieey-dashboard/reviews"
                      className="btn text-right"
                    >
                      <img src="/images/nav/archive-minus.svg" alt="" />
                      <span>التقــيـيـمات</span>
                    ...
                    <Link
                      href="/sanieey-dashboard/projects"
                      className="btn text-right"
                    >
                      <img src="/images/nav/Work.svg" alt="" />
          ...
          <div className="hidden lg:flex space-x-3">
            ...
            <Link className="btn sign-btn" href="/sign">
              ...
              >
                ...
                />
                <path
                  d="M9.86523 7.20483L12.7932 10.1208L9.86523 13.0368"
                  stroke="white"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
