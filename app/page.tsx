        ...
        <section className="services">
          ...
          <div className="frame-9">
            <div className="div-10">
              ...
              &ldquo;
                وفرنا لك مجموعة متنوعة من المهن والحرف لتغطية جميع احتياجاتك المنزلية، من الصيانة والإصلاحات إلى التشطيبات والديكور، مع فريق من المتخصصين الموثوقين الذين يضمنون لك الخدمة الأمثل بجودة عالية وسرعة في الأداء.&ldquo;
              </p>
              </div>
            </div>
          </div>
