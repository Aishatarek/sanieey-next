...
const page = () => {
  ...
  const handleSignIn = async () => {
    try {
      const response = await fetch(
        "https://sani3ywebapiv1.runasp.net/api/UserAuth/signin-normal",
        {
          method: "POST",
  ...
  const handleSignUp = async () => {
    try {
      const response = await fetch(
        "https://sani3ywebapiv1.runasp.net/api/UserAuth/signup",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleGoogleLogin = async (credentialResponse) => {
    try {
      const response = await fetch(
        "https://sani3ywebapiv1.runasp.net/api/UserAuth/google-signin",
        {
          method: "POST",
          headers: {
  ...
  return (
    <GoogleOAuthProvider clientId="1018959177270-ut9tsbsl5oravu0qj34ofj7aqq9epbqm.apps.googleusercontent.com">
            ...
            <div className="tabs tabs-box">
              ...
              <div className="tab-content bg-base-100 border-base-300 p-6">
                <div className="container02">
                  ...
                  <button className="btn-mes" onClick={handleSignUp}>
                  ...
                  <p className="want-sign">
                    تريد انشاء حساب كصنايعي؟{" "}
                    <Link href="/sanieey-sign">سجل الان</Link>!
                  </p>
                </div>
              </div>
                ...
                <div className="container02">
                  ...
                  <div className="text-left mt-1">
                    <Link
                      ...
                      className="font-somar font-normal text-[20px] leading-[22px] tracking-[0px] text-justify text-blue-600"
                    >
                      نسيت كلمة المرور؟
                    </Link>
                  </div>
