...
const page = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://sani3ywebapiv1.runasp.net/api/CraftsmanWorks/upload-previous-work', {
                method: 'POST',
                headers: {
                                    ...
                                    <div className="req-date">
                                        ...
                                        <div className="req-d-3">
                                            ...
                                            <div className="req-d-0">
                                                ...
                                                <div>
                                                    <label htmlFor="image-input" className="clik">
