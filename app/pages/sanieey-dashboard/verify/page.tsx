...
const page = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://sani3ywebapiv1.runasp.net/api/Verification/submit', {
                method: 'POST',
                headers: {
            ...
            router.push('/sanieey-dashboard/main-dashboard')
        } catch (error) {
                        ...
                        <div className='personal-container'>
                            <div>
                                <ul className="personal-menu">
                                    ...
                                    <Link href="/sanieey-dashboard/verification">
                                        <li className="btn0 active">
                                            <svg className="svg-a" xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                <path d="M12 22.5C17.5228 22.5 22 18.0228 22 12.5C22 6.97715 17.5228 2.5 12 2.5C6.47715 2.5 2 6.97715 2 12.5C2 18.0228 6.47715 22.5 12 22.5Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                <path d="M7.75 12.5L10.58 15.33L16.25 9.67004" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                            التحقق من الهوية
                                        </li>
                                    </Link>
                                ...
                                <div className="reqw">
                                    <div className="req-req">
                                        <div className="req-d-3">
                                            <div>
                                                <label className="l1">صورة شخصية واضحة</label>
                                            </div>
                                            <div className="req-d-0">
                                                ...
                                                <div>
                                                    <label htmlFor="profile-image-input" className="clik">
                                                        {previewImages.profileImage ? 'تم اختيار صورة' : 'اضغط هنا لتحميل الصورة'}
                                                    </label>
                                                    <input 
                                                        type="file" 
                                                ...
                                                <div>
                                                    <span>صيغة JPG و PNG فقط - الحد الأقصى (5 ميجابايت)</span>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="req-d-3 mt-4">
                                            <div>
                                                <label className="l1">صورة بطاقة الهوية أو الرخصة</label>
                                            </div>
                                            <div className="req-d-0">
                                                <div>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <div>
                                                    <label htmlFor="card-image-input" className="clik">
                                                        {previewImages.cardImage ? 'تم اختيار صورة' : 'اضغط هنا لتحميل الصورة'}
                                                    </label>
                                                    <input 
                                                        type="file" 
                                                        id="card-image-input"
                                                ...
                                                {previewImages.cardImage && (
                                                    <div className="mt-2">
                                                        <img 
                                                            src={previewImages.cardImage} 
                                                            alt="Card preview" 
                                                            className="h-20 w-20 object-cover rounded"
                                                        />
                                                    </div>
                                    ...
                                    <div className="btn-w">
                                        <button type="submit" className="btn-tmtm" disabled={loading}>
                                            <span>
                                                {loading ? 'جاري التحقق...' : 'إرسال للتحقق'}
                                            </span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
