        ...
        <div className='bg-white'>
            ...
            <div className="flex flex-wrap gap-4 p-4">
                ...
                <div className="w-full  md:w-8/12">
                        <div className="nam"><span>إدارة الـطـلـبـات  </span> <img src="/images/Fill 177.svg" alt="" />
                        </div>
                        <div className="flex gap-4 p-4">

                        <ul className="personal-menu  mt-8 w-full  md:w-3/12">
