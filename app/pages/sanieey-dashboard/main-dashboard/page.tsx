                                            ...
                                            <div className="kl-1">
                                                ...
                                                <div>
                                                    <ul className="child-uesr-0">
                                                        <li className="num-1">عدد الطلبات الواردة : <span className="z1">300 طلب</span></li>
                                                        <li className="num-1">   الطلبات التي تم تنفيذها : <span className="z1">300 طلب</span></li>
                                                        <li className="num-1">الطلبات قيد التنفيذ : <span className="z1">300 طلب</span></li>
                                                        <li className="num-1">   الطلبات التي تم رفضها :<span className="z1">300 طلب</span></li>
