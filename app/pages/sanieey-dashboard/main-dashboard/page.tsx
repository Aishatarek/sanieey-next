...
const Page = () => {
    const [stats, setStats] = useState({
        ...
        requestsCompleted: 0,
        requestsUnderImplementation: 0,
        requestsRejected: 0,
        averageResponseTime: 0,
        averageExecutionTime: 0,
        averageMonthlyProjects: 0
    });
    ...
    useEffect(() => {
        const fetchStatistics = async () => {
            try {
                ...
                const response = await fetch('https://sani3ywebapiv1.runasp.net/api/Craftsmen/statistics', {
                    method: 'GET',
                    headers: {
                        'accept': '*/*',
                        ...
                        <div>
                            <ul className="personal-menu">
                                <Link href="/sanieey-dashboard/main-dashboard">
                                    <li className="btn0 active" id="hd">
                    ...
                    <div className="cv">
                        <div className="sidebar" id="sidebar">
                            <div id="info-container">
                                <div id="info1" className="info-content">
                                    <div className="info10"></div>

                                    <div className="info10-0">
                                        <div className="info10-01">
                                            <div className="c2">
                                                <img className="img-info-01" src="/images/task-square.svg" alt="" />
                                                <span className="s1">مشاريع تم تنفيذها</span>
                                            </div>
                                            <div>
                                                <span className="s2">
                                        ...
                                        <div className="info10-02">
                                            <div className="c2">
                                                <img className="img-info-01" src="/images/routing.svg" alt="" />
                                                <span className="s4"> مناطق تم العمل بها </span>
                                            </div>
                                            <div>
                                                <span className="s5">
                                                    {loading ? '...' : stats.areasWorkedIn}
                                                </span>
                                                <span className="s6">
                                                    مناطق
                                                </span>
                                        ...
                                        <div className="info10-02">
                                            <div className="c2">
                                                <img className="img-info-01" src="/images/star-uesr.svg" alt="" />
                                                <span className="s4">  متوسط التقييمات </span>
                                            </div>
                                            <div>
                                                <span className="s5">
                                    ...
                                    <div className="info10-1">
                                        <div className="kl-1">
                                            <div><span>احصــائـيات عـامـة :</span></div>
                                            <div>
                                                <ul className="child-uesr-0">
                                                    <li className="num-1">عدد الطلبات الواردة : 
                                                        <span className="z1">{loading ? '...' : `${stats.totalIncomingRequests} طلب`}</span>
                                                    </li>
                                                    <li className="num-1">الطلبات التي تم تنفيذها : 
                                                        <span className="z1">{loading ? '...' : `${stats.requestsCompleted} طلب`}</span>
                                                    </li>
                                                    <li className="num-1">الطلبات قيد التنفيذ : 
                                                        <span className="z1">{loading ? '...' : `${stats.requestsUnderImplementation} طلب`}</span>
                                                    </li>
                                                    <li className="num-1">الطلبات التي تم رفضها :
                                                        <span className="z1">{loading ? '...' : `${stats.requestsRejected} طلب`}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className="kl-2">
                                            <div className="kl-02">
                                                <div className="kl-02s">
                                                    <span className="kl-s">{loading ? '...' : stats.averageMonthlyProjects}</span>
                                                    <span className="s5">مشروع</span>
                                                </div>
                                                <div><span className="kl-s0">متوسط عدد المشاريع شهرياً</span></div>
                                            </div>
                                            <div className="kl-02">
                                                <div className="kl-02s">
                                                    <span className="kl-s">{loading ? '...' : stats.averageExecutionTime}</span>
                                                    <span className="s5">أيــام</span>
                                                </div>
                                                <div><span className="kl-s0">متوسط مدة التنفيذ</span></div>
                                            </div>
                                            <div className="kl-02">
                                                <div className="kl-02s">
                                                    <span className="kl-s">{loading ? '...' : stats.averageResponseTime}</span>
                                                    <span className="s5">ساعات</span>
                                                </div>
                                                <div><span className="kl-s0">متوسط زمن الاستجابة</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
