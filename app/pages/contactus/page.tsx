...
const page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      Swal.fire("خطأ", "من فضلك املأ كل الحقول", "error");
      return;
    }

    try {
      const response = await fetch(
        "https://sani3ywebapiv1.runasp.net/api/ContactUs/submit",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        Swal.fire("نجاح", "تم الإرسال بنجاح!", "success");
        setFormData({
          name: "",
          email: "",
          phoneNumber: "",
  ...
  return (
    <div>
      <div className="contact-1">
        <div className="nam">
          <span> تــــواصـــل مـــعــنـا </span>{" "}
          <img src="/images/Fill 177.svg" alt="" />
        </div>
        <div className="con-2">
          إذا كانت لديك أي مشاكل أو إستفسارات لا تتردد في التواصل معنا من خلال
          النموذج التالي أو من خلال قنوات التواصل الأخرى.
        </div>
        <div className="con-3">
          <form className="container02" onSubmit={handleSubmit}>
            ...
            <div className="phone-email">
              <div className="xz">
                ...
                <div className="phone-input">
                  <span>
                    +2 <img src="/images/Egypt (EG).svg" alt="" />
                  </span>
                  <input
                    type="text"
                    name="phoneNumber"
            ...
            <div className="area">
              ...
              <div className="text-area">
                <textarea
                  name="messageContent"
                  id="messageContent"
                  placeholder="كيف يمكننا مساعدتك؟ اترك رسالتك هنا..."
          ...
          <div className="modal01" id="successModal">
            <div className="model02">
              <div>
                ...
                >
                  ...
                  <g mask="url(#mask0_657_6149)">
                    <path
                      d="M47.511 61.793C47.1205 62.1835 46.4873 62.1835 46.0968 61.793L36.586 52.2822C36.1955 51.8916 36.1955 51.2585 36.586 50.868L37.903 49.5509C38.2936 49.1604 38.9267 49.1604 39.3173 49.5509L46.0968 56.3305C46.4873 56.721 47.1205 56.721 47.511 56.3305L63.6822 40.1593C64.0727 39.7687 64.7059 39.7687 65.0964 40.1593L66.4135 41.4763C66.804 41.8668 66.804 42.5 66.4135 42.8905L47.511 61.793Z"
                      fill="white"
                    />
                  </g>
                </svg>
              ...
              <div>
                {" "}
                <span>تم الإرســال بنجاح!</span>
              </div>
              <div>
                {" "}
                <span>سنرد على رسالتك في اقرب وقت</span>
              </div>
              <div>
                <button>
                  {" "}
        ...
        <div className="con-4">
          <div className="cill-1">
            <div className="span-1">
              {" "}
              <span>الأســئـلـــة الــشــائـــعــة</span>
            </div>
            <div className="span-2">
              {" "}
              <span>
                أهـــــــم الاســــئــلـــــة الـــشــــائـــــــعـــة
              </span>
            </div>
            <div className="span-3">
              {" "}
              <span>
                اطلعوا على أهم الأسئلة الشائعة للحصول على إجابات وافية حول
                خدماتنا وكيفية الاستفادة منها بأفضل شكل.
              </span>
            </div>
          </div>
          <div className="con-5">
            <div className="collapse collapse-plus bg-base-100 border border-base-300">
              ...
              <div className="collapse-title font-semibold">
                مــا هــو مــوقـع &quot;صنــايـعي بلس&quot; ومــا الــهــدف
                مــنه؟
              </div>
              <div className="collapse-content text-sm">
                موقع صنايعي بلس يوفر لك الصنايعي المناسب لاحتياجاتك بناءاً على
                تقييمات موثوقة وقاعدة بيانات كبيرة تشمل جميع التخصصات لتسهيل
                عملية الاختيار بدلاً من الانتظار للحصول على توصيات مباشرة.
              </div>
            </div>
            <div className="collapse collapse-plus bg-base-100 border border-base-300">
              <input type="radio" name="my-accordion-3" defaultChecked />
